...
public class honeygaincase102_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase102_splash);
    ...
    void datafromlink() {
        new AsyncTask< Void, Void, String >() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/69a3480434/ads.txt";
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                honeygaincase102_SplashActivity.this.startActivity(new Intent(honeygaincase102_SplashActivity.this, honeygaincase102_start_page.class));
